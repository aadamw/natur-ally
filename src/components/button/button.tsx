  ...
  "inline-flex select-none items-center justify-center rounded-[5px] whitespace-nowrap font-semibold transition-colors aria-disabled:pointer-events-none aria-disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-purple-gray/0.2 border border-purple-gray bg-light-purple hover:[@media(pointer:fine)]:bg-light-purple-hover active:bg-light-purple-active",
      },
      size: {
        default: "h-12 px-6 py-4 text-base w-[238px] h-[52px]",
      },
    },
    defaultVariants: {
      variant: "default",
